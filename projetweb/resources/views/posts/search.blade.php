...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="cs/style.css"> <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
...
<h1>Articles @include('partials.search')</h1>
    @if(count($posts) >=1 )
